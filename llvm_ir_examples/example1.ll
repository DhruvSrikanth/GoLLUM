...
L10:
	...
	%r42 = load i64, i64* %c
	%r43 = load i64, i64* %d
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.fstr2, i32 0, i32 0), i64 %r42, i64 %r43)
	br label %L11
...
@.fstr2 = private unnamed_addr constant [13 x i8] c"c=%ld\0Ad=%ld\0A\00", align 1
