...
L43:
	...
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.fstr1, i32 0, i32 0), i64 %r107)
	br label %L44
...
@.fstr1 = private unnamed_addr constant [19 x i8] c"Max Factorial=%ld\0A\00", align 1
