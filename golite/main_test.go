...
func TestLexer(t *testing.T) {
	...
	var lexTests = []struct {
		...
		{"../benchmarks/simple/simple5.golite", []string{"type", "Point", "struct", "{", "x", "int", ";", "y", "int", ";", "}", ";", "func", "main", "(", ")", "{", "var", "p1", "*", "Point", ";", "var", "p2", "*", "Point", ";", "var", "result", "int", ";", "p1", "=", "new", "Point", ";", "p2", "=", "new", "Point", ";", "p1", ".", "x", "=", "10", ";", "p1", ".", "y", "=", "20", ";", "p2", ".", "x", "=", "30", ";", "p2", ".", "y", "=", "40", ";", "result", "=", "distance2D", "(", "p1", ",", "p2", ")", ";", "printf", "(", "\"The squared distance between the two points is %d\"", ",", "l2Squared", ")", ";", "delete", "p1", ";", "delete", "p2", ";", "return", ";", "}", "func", "distance2D", "(", "p1", "*", "Point", ",", "p2", "*", "Point", ")", "int", "{", "var", "dx", ",", "dy", "int", ";", "var", "l2Squared", "int", ";", "dx", "=", "p1", ".", "x", "-", "p2", ".", "x", ";", "dy", "=", "p1", ".", "y", "-", "p2", ".", "y", ";", "l2Squared", "=", "dx", "*", "dx", "+", "dy", "*", "dy", ";", "return", "l2Squared", ";", "}", "<EOF>"}},
