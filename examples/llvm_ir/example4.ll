...
L8:
	...
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.fstr1, i32 0, i32 0), i64 %r24)
	br label %L10
...
L9:
	...
	call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.fstr2, i32 0, i32 0), i64 %r28)
